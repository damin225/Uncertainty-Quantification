...
for i=1:Nosample
    ...
    f(i) = 1;
    for j=1:Nobs
        f(i) = f(i)*(normpdf(Yobs(j),Ypred,sigma));
    end

    % compute ratio and decide to accept or reject, note the range of
    % uniform distribution
    alpha(i) = f(i)*range_uni(E1,10000,70000)*range_uni(E2,10000,70000)...
        *range_uni(E3,10000,70000)*range_uni(E4,10000,70000)...
        *range_uni(sigma,0.04,0.12)/(M*(normpdf(E1,E1_old,3000)...
